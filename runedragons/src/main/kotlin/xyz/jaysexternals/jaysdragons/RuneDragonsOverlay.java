...
class RuneDragonsOverlay extends OverlayPanel
{
	...
	@Inject
	private RuneDragonsOverlay(final Client client, final RuneDragonsPlugin plugin, final RuneDragonsConfig config)
	{
		super(plugin);
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		if (!tableComponent.isEmpty())
		{
			...
			panelComponent.getChildren().add(TitleComponent.builder()
				.text("Jay's Rune Dragons")
				.color(ColorUtil.fromHex("#8A5FAD"))
				.build());
